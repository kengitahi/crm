    ...
    <div class="col-sm-12">
        <x-form id="save-finishes-data-form">
            ...
            <div class="add-resource rounded bg-white">
                ...
                <div class="row p-20">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <x-forms.number :fieldLabel="__('modules.projects.formLabels.woodenStairs')" :fieldPlaceholder="__('placeholders.projects.amount')" :fieldValue="$lead->client_name ?? ''"
                            ...
                            <div class="col-md-4">
                                <x-forms.number :fieldLabel="__('modules.projects.formLabels.marbleAndGranites')" :fieldPlaceholder="__('placeholders.projects.amount')" :fieldValue="$lead->client_name ?? ''"
                            ...
                            <div class="col-md-4">
                                <x-forms.number :fieldLabel="__('modules.projects.formLabels.woodenStave')" :fieldPlaceholder="__('placeholders.projects.amount')" :fieldValue="$lead->client_name ?? ''"
                            ...
                            <div class="col-md-4">
                                <x-forms.number :fieldLabel="__('modules.projects.formLabels.wallCovering')" :fieldPlaceholder="__('placeholders.projects.amount')" :fieldValue="$lead->client_name ?? ''"
                            ...
                            <div class="col-md-4">
                                <x-forms.number :fieldLabel="__('modules.projects.formLabels.kitchens')" :fieldPlaceholder="__('placeholders.projects.amount')" :fieldValue="$lead->client_name ?? ''"
                            ...
                            <div class="col-md-4">
                                <x-forms.number :fieldLabel="__('modules.projects.formLabels.carpentry')" :fieldPlaceholder="__('placeholders.projects.amount')" :fieldValue="$lead->client_name ?? ''"
                            ...
                            <div class="col-md-4">
                                <x-forms.number :fieldLabel="__('modules.projects.formLabels.bathroomFurniture')" :fieldPlaceholder="__('placeholders.projects.amount')" :fieldValue="$lead->client_name ?? ''"
                            ...
                            <div class="col-md-4">
                                <x-forms.number :fieldLabel="__('modules.projects.formLabels.outdoorAreas')" :fieldPlaceholder="__('placeholders.projects.amount')" :fieldValue="$lead->client_name ?? ''"
                            ...
                            <div class="col-md-4">
                                <x-forms.number :fieldLabel="__('modules.projects.formLabels.marbleSlabs')" :fieldPlaceholder="__('placeholders.projects.amount')" :fieldValue="$lead->client_name ?? ''"
                            ...
                            <div class="col-md-4">
                                <x-forms.number :fieldLabel="__('modules.projects.formLabels.floor')" :fieldPlaceholder="__('placeholders.projects.amount')" :fieldValue="$lead->client_name ?? ''"
                ...
                <x-form-actions>
                    <x-forms.button-primary class="mr-3" icon="check" id="save-finishes-form">@lang('app.save')

    ...
    <div class="col-sm-12">
        <x-form id="save-wiring-data-form">
            ...
            <div class="add-resource rounded bg-white">
                ...
                <h4 class="f-21 font-weight-normal border-bottom-grey mb-0 p-20">
                    @lang('modules.projects.titles.lightingFixturesAndAccessories')
                </h4>
                <div class="row p-20">
                    <div class="col-lg-9">
                        <div class="row">
...
<script>
    $(document).ready(function() {
        $('#save-wiring-form').click(function() {
            const url = "{{ route('projectfinances.storeWiring') }}";
        ...
        function saveClient(data, url, buttonSelector) {
            $.easyAjax({
                url: url,
                container: '#save-wiring-data-form',
                type: "POST",
                disableButton: true,
                blockUI: true,

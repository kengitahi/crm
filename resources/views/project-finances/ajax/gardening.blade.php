    ...
    <div class="col-sm-12">
        <x-form id="save-gardening-data-form">
            ...
            <div class="add-resource rounded bg-white">
                ...
                <div class="row p-20">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <x-forms.number :fieldLabel="__('modules.projects.formLabels.plantsAndPots')" :fieldPlaceholder="__('placeholders.projects.amount')" :fieldValue="$lead->client_name ?? ''"
                ...
                <x-form-actions>
                    <x-forms.button-primary class="mr-3" icon="check" id="save-gardening-form">@lang('app.save')

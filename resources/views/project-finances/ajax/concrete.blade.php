<div class="row">
    <div class="col-sm-12">
        <x-form id="save-concrete-data-form">
            ...
            <div class="add-resource rounded bg-white">
                ...
                <x-form-actions>
                    @if (request()->action == 'edit')
                        <x-forms.button-primary class="mr-3" icon="edit" id="update-concrete-form">
                            @lang('app.update')
...
<script>
    $(document).ready(function() {
        $('#save-concrete-form').click(function() {
            const url = "{{ route('projectfinances.storeConcrete') }}";
        ...
        function saveClient(data, url, buttonSelector) {
            $.easyAjax({
                url: url,
                container: '#save-concrete-data-form',
                type: "POST",
                disableButton: true,
                blockUI: true,

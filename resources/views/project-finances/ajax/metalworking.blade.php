<div class="row">
    <div class="col-sm-12">
        <x-form id="save-metalworking-data-form">
            ...
            <div class="add-resource rounded bg-white">
                ...
                <div class="row p-20">
                    <div class="col-lg-9">
                        <div class="row">
                            <input name="form_type" type="hidden" value="metalworking">
                            <div class="col-md-4">
                ...
                <x-form-actions>
                    @if (request()->action == 'edit')
                        <x-forms.button-primary class="mr-3" icon="pencil" id="update-metalworking-form">
                            @lang('app.save')
                        </x-forms.button-primary>
                    @else
                        <x-forms.button-primary class="mr-3" icon="check" id="save-metalworking-form">
                            @lang('app.save')
                        </x-forms.button-primary>
                    @endif
                    <x-forms.button-cancel :link="route('projectfinances.index') . '?tab=metalworking'" class="border-0">@lang('app.cancel')
...
<script>
    $(document).ready(function() {
        ...
        $('#update-metalworking-form').click(function() {
            // Get the current URL
        ...
        function saveClient(data, url, buttonSelector) {
            $.easyAjax({
                url: url,
                container: '#save-metalworking-data-form',
                type: "POST",
                disableButton: true,
                blockUI: true,

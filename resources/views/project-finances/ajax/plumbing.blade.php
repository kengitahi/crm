            ...
            <div class="add-resource rounded bg-white">
                ...
                <div class="row p-20">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <x-forms.number :fieldLabel="__('modules.projects.formLabels.hydropneumaticSystem')" :fieldPlaceholder="__('placeholders.projects.amount')" :fieldValue="$costToEdit->hydropneumatic_system ?? ''"
                            ...
                            <div class="col-md-4">
                                <x-forms.number :fieldLabel="__('modules.projects.formLabels.sprinklerIrrigationSystem')" :fieldPlaceholder="__('placeholders.projects.amount')" :fieldValue="$costToEdit->automated_sprinkler ?? ''"
                            ...
                            <div class="col-md-4">
                                <x-forms.number :fieldLabel="__('modules.projects.formLabels.tank')" :fieldPlaceholder="__('placeholders.projects.amount')" :fieldValue="$costToEdit->tank ?? ''"
                            ...
                            <div class="col-md-4">
                                <x-forms.number :fieldLabel="__('modules.projects.formLabels.basicMaterial')" :fieldPlaceholder="__('placeholders.projects.amount')" :fieldValue="$costToEdit->basic_material ?? ''"
                            ...
                            <div class="col-md-4">
                                <x-forms.number :fieldLabel="__('modules.projects.formLabels.heater')" :fieldPlaceholder="__('placeholders.projects.amount')" :fieldValue="$costToEdit->heater ?? ''"
                            ...
                            <div class="col-md-4">
                                <x-forms.number :fieldLabel="__('modules.projects.formLabels.bathroom')" :fieldPlaceholder="__('placeholders.projects.amount')" :fieldValue="$costToEdit->bathroom ?? ''"
                ...
                <x-form-actions>
                    @if (request()->action == 'edit')
                        <x-forms.button-primary class="mr-3" icon="edit" id="update-plumbing-form">
                            @lang('app.update')
                        </x-forms.button-primary>
                    @else
                        <x-forms.button-primary class="mr-3" icon="check" id="save-plumbing-form">
                            @lang('app.save')
                        </x-forms.button-primary>
                    @endif
...
<script>
    $(document).ready(function() {
        ...
        $('#update-plumbing-form').click(function() {
            // Get the current URL
            ...
            const url = "{!! route('projectfinances.update') . '?tab=plumbing&id=' !!}" + id + "{!! '&model=Plumbing' !!}";
            var data = $('#save-plumbing-data-form').serialize();

            console.log(url);
            console.log(data);

            saveClient(data, url, "#update-plumbing-form");

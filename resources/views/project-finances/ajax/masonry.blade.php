    ...
    <div class="col-sm-12">
        <x-form id="save-masonry-data-form">
            ...
            <div class="add-resource rounded bg-white">
                <div class="row p-20">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <x-forms.number :fieldLabel="__('modules.projects.formLabels.supervision')" :fieldPlaceholder="__('placeholders.projects.amount')" :fieldValue="$lead->client_name ?? ''"
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <x-forms.number :fieldLabel="__('modules.projects.formLabels.several')" :fieldPlaceholder="__('placeholders.projects.amount')" :fieldValue="$lead->client_name ?? ''"
                                    fieldId="{{ __('modules.projects.formFields.several') }}"
                                    fieldName="{{ __('modules.projects.formFields.several') }}">
                                </x-forms.number>
                            </div>
                            <div class="col-md-4">
                                <x-forms.number :fieldLabel="__('modules.projects.formLabels.scaffolding')" :fieldPlaceholder="__('placeholders.projects.amount')" :fieldValue="$lead->client_name ?? ''"
                                    fieldId="{{ __('modules.projects.formFields.scaffolding') }}"
                                    fieldName="{{ __('modules.projects.formFields.scaffolding') }}">
                                </x-forms.number>
                            </div>
                            <div class="col-md-4">
                                <x-forms.number :fieldLabel="__('modules.projects.formLabels.mixerAndEquipment')" :fieldPlaceholder="__('placeholders.projects.amount')" :fieldValue="$lead->client_name ?? ''"
                ...
                <x-form-actions>
                    <x-forms.button-primary class="mr-3" icon="check" id="save-masonry-form">@lang('app.save')

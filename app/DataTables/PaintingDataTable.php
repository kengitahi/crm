...
class PaintingDataTable extends BaseDataTable
{
     ...
     */
    public function query(Painting $model): QueryBuilder
    {
    ...
    {
        $dataTable = $this->setBuilder('painting-table');

        $dataTable->setTableId('painting-table');
        ...
        $dataTable->parameters([
            'initComplete' => 'function () {
                   window.LaravelDataTables["painting-table"].buttons().container()
    ...
    public function getColumns(): array
    {
        ...
        return array_merge(
            $columns,
            CustomFieldGroup::customFieldsDataMerge(new Painting),
            $action
        );
    }

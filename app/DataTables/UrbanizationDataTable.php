...
class UrbanizationDataTable extends BaseDataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        $datatables->addColumn(
            'suppliers',
            fn ($row) => $row->urbanization_suppliers ?: '--'
        );
        ...
        $customFieldColumns = CustomField::customFieldData(
            $datatables,
            UrbanizationCost::CUSTOM_FIELD_MODEL
        );
     ...
     */
    public function query(UrbanizationCost $model): QueryBuilder
    {
    ...
    {
        $dataTable = $this->setBuilder('urbanization-table');

        $dataTable->setTableId('urbanization-table');
        ...
        $dataTable->parameters([
            'initComplete' => 'function () {
                   window.LaravelDataTables["urbanization-table"].buttons().container()
    ...
    public function getColumns(): array
    {
        ...
        return array_merge(
            $columns,
            CustomFieldGroup::customFieldsDataMerge(new UrbanizationCost),
            $action
        );
    }
    ...
    {
        return 'Urbanization_'.date('YmdHis');
    }
}

...
class OtherCostsDataTable extends BaseDataTable
{
     ...
     */
    public function query(OtherCosts $model): QueryBuilder
    {
    ...
    {
        $dataTable = $this->setBuilder('other-costs-table');

        $dataTable->setTableId('other-costs-table');
        ...
        $dataTable->parameters([
            'initComplete' => 'function () {
                   window.LaravelDataTables["other-costs-table"].buttons().container()
    ...
    public function getColumns(): array
    {
        $columns = [
            Column::make('id'),
            __('modules.projects.formLabels.otherCosts') => [
                'data' => 'other_costs',
                'name' => 'other_costs',
                'title' => __('modules.projects.formLabels.otherCosts'),
                'visible' => showId(),
                'orderable' => false,
            ],
            __('app.createdAt') => [
        ...
        return array_merge(
            $columns,
            CustomFieldGroup::customFieldsDataMerge(new OtherCosts),
            $action
        );
    }
    ...
    {
        return 'OtherCosts_'.date('YmdHis');
    }
}

...
class ConcreteDataTable extends BaseDataTable
{
     ...
     */
    public function query(ConcreteStructure $model): QueryBuilder
    {
    ...
    {
        $dataTable = $this->setBuilder('concrete-table');

        $dataTable->setTableId('concrete-table');
        ...
        $dataTable->parameters([
            'initComplete' => 'function () {
                   window.LaravelDataTables["concrete-table"].buttons().container()

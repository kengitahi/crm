...
class AirconDataTable extends BaseDataTable
{
     ...
     */
    public function query(AirCon $model): QueryBuilder
    {
    ...
    {
        $dataTable = $this->setBuilder('aircon-table');

        $dataTable->setTableId('aircon-table');
        ...
        $dataTable->parameters([
            'initComplete' => 'function () {
                   window.LaravelDataTables["aircon-table"].buttons().container()

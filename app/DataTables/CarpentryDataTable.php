...
class CarpentryDataTable extends BaseDataTable
{
     ...
     */
    public function query(Capentry $model): QueryBuilder
    {
    ...
    {
        $dataTable = $this->setBuilder('capentry-table');

        $dataTable->setTableId('capentry-table');
        ...
        $dataTable->parameters([
            'initComplete' => 'function () {
                   window.LaravelDataTables["capentry-table"].buttons().container()

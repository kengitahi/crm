...
class GardeningDataTable extends BaseDataTable
{
     ...
     */
    public function query(Gardening $model): QueryBuilder
    {
    ...
    {
        $dataTable = $this->setBuilder('gardening-table');

        $dataTable->setTableId('gardening-table');
        ...
        $dataTable->parameters([
            'initComplete' => 'function () {
                   window.LaravelDataTables["gardening-table"].buttons().container()

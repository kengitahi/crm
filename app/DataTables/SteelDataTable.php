...
class SteelDataTable extends BaseDataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        $customFieldColumns = CustomField::customFieldData(
            $datatables,
            SteelStructure::CUSTOM_FIELD_MODEL
        );
     ...
     */
    public function query(SteelStructure $model): QueryBuilder
    {
    ...
    {
        $dataTable = $this->setBuilder('steel-table');

        $dataTable->setTableId('steel-table');
        ...
        $dataTable->parameters([
            'initComplete' => 'function () {
                   window.LaravelDataTables["steel-table"].buttons().container()
    ...
    public function getColumns(): array
    {
        $columns = [
            Column::make('id'),
            'Steel '.__('modules.projects.formLabels.suppliers') => [
                'data' => 'steel_suppliers',
                'name' => 'suppliers',
                'title' => 'Steel '.__('modules.projects.formLabels.suppliers'),
                'visible' => showId(),
                'orderable' => false,
            ],
            __('app.createdAt') => [
        ...
        return array_merge(
            $columns,
            CustomFieldGroup::customFieldsDataMerge(new SteelStructure),
            $action
        );
    }
    ...
    {
        return 'SteelStructure_'.date('YmdHis');
    }
}

...
class WaterproofingDataTable extends BaseDataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        $customFieldColumns = CustomField::customFieldData(
            $datatables,
            Waterproofing::CUSTOM_FIELD_MODEL
        );
     ...
     */
    public function query(Waterproofing $model): QueryBuilder
    {
    ...
    {
        $dataTable = $this->setBuilder('waterproofing-table');

        $dataTable->setTableId('waterproofing-table');
        ...
        $dataTable->parameters([
            'initComplete' => 'function () {
                   window.LaravelDataTables["waterproofing-table"].buttons().container()
    ...
    public function getColumns(): array
    {
        ...
        return array_merge(
            $columns,
            CustomFieldGroup::customFieldsDataMerge(new Waterproofing),
            $action
        );
    }
    ...
    {
        return 'Waterproofing_'.date('YmdHis');
    }
}

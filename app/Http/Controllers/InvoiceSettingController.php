...
class InvoiceSettingController extends AccountBaseController
{
    ...
    public function index()
    {
        ...
        switch ($tab) {
            ...
            case 'template':
                ...
                break;
            case 'payment':
                $this->payments = InvoicePaymentDetail::where('company_id', company()->id)->get();
    ...
    public function update(UpdateInvoiceSetting $request)
    {
        ...
        if ($request->hasFile('logo')) {
            ...
            $setting->logo = Files::uploadLocalOrS3($request->logo, GlobalSetting::APP_LOGO_PATH);
        }
        ...
        if ($request->hasFile('authorised_signatory_signature')) {
            ...
            $setting->authorised_signatory_signature = Files::uploadLocalOrS3($request->authorised_signatory_signature, GlobalSetting::APP_LOGO_PATH);
        }
